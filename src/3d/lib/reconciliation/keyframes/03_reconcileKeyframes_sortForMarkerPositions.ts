import type { type_keyframes_reconciledTimeExtended_camera, type_keyframes_reconciledTimeExtended_model } from './02_reconcileKeyframes_expandTime';
import type { type_separatedKeyframes_extended } from './types';

// Legacy functions removed - only separated pipeline is used now
 ...
 */
const sortCameraKeyframesByTime = (keyframes: Array<type_keyframes_reconciledTimeExtended_camera>): Array<type_keyframes_reconciledTimeExtended_camera> => {
 ...
 */
const modelKeyframeHasMarkerPosition = (keyframe: type_keyframes_reconciledTimeExtended_model): boolean => {
 ...
 */
export const sortKeyframesForMarkerPositions = (separatedKeyframes: type_separatedKeyframes_extended): type_separatedKeyframes_extended => {
