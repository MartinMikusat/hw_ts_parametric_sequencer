 ...
 * Manages animation playback, timing, and state updates for 2D scenes.
 */
export class Sequencer2D {
    ...
    /**
     * Gets the set of SceneModel2D instances in the current scene.
     */
    get sceneModels() {
	 ...
	 * @returns AnimationSnapshot2D containing the state of all models and camera, or null if no scene loaded
	 */
